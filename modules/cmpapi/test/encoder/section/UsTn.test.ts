...
describe("manifest.section.UsTn", (): void => {
  it("should encode default to BAAAAAQ.Q", (): void => {
    let usTn = new UsTn();
    expect(usTn.encode()).to.eql("BAAAAAQ.Q");
  });
