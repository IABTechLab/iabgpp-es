...
describe("manifest.section.UspCoV1", (): void => {
  ...
  it("should encode default to BAAAAAA", (): void => {
    ...
    expect(uspCoV1.encode()).to.eql("BAAAAAA");
  });
  ...
  it("should decode BbYbG2w.YA", (): void => {
    ...
    expect(true, uspCoV1.getFieldValue(UspCoV1Field.GPC_SEGMENT_INCLUDED));
  });

  it("should decode BbYbG2w", (): void => {
    let uspCoV1 = new UspCoV1("BbYbG2w");
    ...
    expect(2, uspCoV1.getFieldValue(UspCoV1Field.MSPA_OPT_OUT_OPTION_MODE));
    expect(3, uspCoV1.getFieldValue(UspCoV1Field.MSPA_SERVICE_PROVIDER_MODE));
    expect(false, uspCoV1.getFieldValue(UspCoV1Field.GPC_SEGMENT_INCLUDED));
  });
});
