...
describe("manifest.section.TcfCaV1", (): void => {
  it("should encode default to BPSG_8APSG_8AAAAAAENAABAAAAAAAAAAAAAAAAA.YAAAAAAAAAA", (): void => {
    ...
    expect(tcfCaV2.encode()).to.eql("BPSG_8APSG_8AAAAAAENAABAAAAAAAAAAAAAAAAA.YAAAAAAAAAA");
  });

  it("should encode to BPSG_8APSG_8AAyACAENGdBgf_gfgAfgfgBgABABAAABAB4AACAC.fHHHA4444ao", (): void => {
    let tcfCaV2 = new TcfCaV1();
    ...
    expect(tcfCaV2.encode()).to.eql("BPSG_8APSG_8AAyACAENGdBgf_gfgAfgfgBgABABAAABAB4AACAC.fHHHA4444ao");
  });
