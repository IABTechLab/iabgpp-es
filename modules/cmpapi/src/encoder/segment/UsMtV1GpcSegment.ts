...
import { USMTV1_GPC_SEGMENT_FIELD_NAMES } from "../field/UsMtV1Field.js";
import { UsMtV1Field } from "../field/UsMtV1Field.js";
import { AbstractLazilyEncodableSegment } from "./AbstractLazilyEncodableSegment.js";

export class UsMtV1GpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {
  ...
  public getFieldNames(): string[] {
    return USMTV1_GPC_SEGMENT_FIELD_NAMES;
  }

  // overriden
  protected initializeFields(): EncodableBitStringFields {
    let fields: EncodableBitStringFields = new EncodableBitStringFields();
    fields.put(UsMtV1Field.GPC_SEGMENT_TYPE.toString(), new EncodableFixedInteger(2, 1));
    fields.put(UsMtV1Field.GPC_SEGMENT_INCLUDED.toString(), new EncodableBoolean(true));
    fields.put(UsMtV1Field.GPC.toString(), new EncodableBoolean(false));
    return fields;
  }
  ...
  protected decodeSegment(encodedString: string, fields: EncodableBitStringFields): void {
    ...
    try {
      ...
      throw new DecodingError("Unable to decode UsMtV1GpcSegment '" + encodedString + "'");
    }
  }
}
