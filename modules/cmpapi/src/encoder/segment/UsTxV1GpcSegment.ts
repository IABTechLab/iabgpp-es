...
import { USTXV1_GPC_SEGMENT_FIELD_NAMES } from "../field/UsTxV1Field.js";
import { UsTxV1Field } from "../field/UsTxV1Field.js";
import { AbstractLazilyEncodableSegment } from "./AbstractLazilyEncodableSegment.js";

export class UsTxV1GpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {
  ...
  public getFieldNames(): string[] {
    return USTXV1_GPC_SEGMENT_FIELD_NAMES;
  }

  // overriden
  protected initializeFields(): EncodableBitStringFields {
    let fields: EncodableBitStringFields = new EncodableBitStringFields();
    fields.put(UsTxV1Field.GPC_SEGMENT_TYPE.toString(), new EncodableFixedInteger(2, 1));
    fields.put(UsTxV1Field.GPC_SEGMENT_INCLUDED.toString(), new EncodableBoolean(true));
    fields.put(UsTxV1Field.GPC.toString(), new EncodableBoolean(false));
    return fields;
  }
  ...
  protected decodeSegment(encodedString: string, fields: EncodableBitStringFields): void {
    ...
    try {
      ...
      throw new DecodingError("Unable to decode UsTxV1GpcSegment '" + encodedString + "'");
    }
  }
}
