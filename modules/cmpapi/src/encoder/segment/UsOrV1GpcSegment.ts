...
import { USORV1_GPC_SEGMENT_FIELD_NAMES } from "../field/UsOrV1Field.js";
import { UsOrV1Field } from "../field/UsOrV1Field.js";
import { AbstractLazilyEncodableSegment } from "./AbstractLazilyEncodableSegment.js";

export class UsOrV1GpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {
  ...
  public getFieldNames(): string[] {
    return USORV1_GPC_SEGMENT_FIELD_NAMES;
  }

  // overriden
  protected initializeFields(): EncodableBitStringFields {
    let fields: EncodableBitStringFields = new EncodableBitStringFields();
    fields.put(UsOrV1Field.GPC_SEGMENT_TYPE.toString(), new EncodableFixedInteger(2, 1));
    fields.put(UsOrV1Field.GPC_SEGMENT_INCLUDED.toString(), new EncodableBoolean(true));
    fields.put(UsOrV1Field.GPC.toString(), new EncodableBoolean(false));
    return fields;
  }
  ...
  protected decodeSegment(encodedString: string, fields: EncodableBitStringFields): void {
    ...
    try {
      ...
      throw new DecodingError("Unable to decode UsOrV1GpcSegment '" + encodedString + "'");
    }
  }
}
