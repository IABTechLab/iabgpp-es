...
import { UsKy_GPC_SEGMENT_FIELD_NAMES } from "../field/UsKyField.js";
import { UsKyField } from "../field/UsKyField.js";
import { AbstractLazilyEncodableSegment } from "./AbstractLazilyEncodableSegment.js";

export class UsKyGpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {
  ...
  public getFieldNames(): string[] {
    return UsKy_GPC_SEGMENT_FIELD_NAMES;
  }

  // overriden
  protected initializeFields(): EncodableBitStringFields {
    let fields: EncodableBitStringFields = new EncodableBitStringFields();
    fields.put(UsKyField.GPC_SEGMENT_TYPE.toString(), new EncodableFixedInteger(2, 1));
    fields.put(UsKyField.GPC_SEGMENT_INCLUDED.toString(), new EncodableBoolean(true));
    fields.put(UsKyField.GPC.toString(), new EncodableBoolean(false));
    return fields;
  }
  ...
  protected decodeSegment(encodedString: string, fields: EncodableBitStringFields): void {
    ...
    try {
      ...
      throw new DecodingError("Unable to decode UsKyGpcSegment '" + encodedString + "'");
    }
  }
}
