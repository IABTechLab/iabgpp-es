...
import { UsMn_GPC_SEGMENT_FIELD_NAMES } from "../field/UsMnField.js";
import { UsMnField } from "../field/UsMnField.js";
import { AbstractLazilyEncodableSegment } from "./AbstractLazilyEncodableSegment.js";

export class UsMnGpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {
  ...
  public getFieldNames(): string[] {
    return UsMn_GPC_SEGMENT_FIELD_NAMES;
  }

  // overriden
  protected initializeFields(): EncodableBitStringFields {
    let fields: EncodableBitStringFields = new EncodableBitStringFields();
    fields.put(UsMnField.GPC_SEGMENT_TYPE.toString(), new EncodableFixedInteger(2, 1));
    fields.put(UsMnField.GPC_SEGMENT_INCLUDED.toString(), new EncodableBoolean(true));
    fields.put(UsMnField.GPC.toString(), new EncodableBoolean(false));
    return fields;
  }
  ...
  protected decodeSegment(encodedString: string, fields: EncodableBitStringFields): void {
    ...
    try {
      ...
      throw new DecodingError("Unable to decode UsMnGpcSegment '" + encodedString + "'");
    }
  }
}
