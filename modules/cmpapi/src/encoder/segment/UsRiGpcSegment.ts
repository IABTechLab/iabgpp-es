...
import { UsRi_GPC_SEGMENT_FIELD_NAMES } from "../field/UsRiField.js";
import { UsRiField } from "../field/UsRiField.js";
import { AbstractLazilyEncodableSegment } from "./AbstractLazilyEncodableSegment.js";

export class UsRiGpcSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {
  ...
  public getFieldNames(): string[] {
    return UsRi_GPC_SEGMENT_FIELD_NAMES;
  }

  // overriden
  protected initializeFields(): EncodableBitStringFields {
    let fields: EncodableBitStringFields = new EncodableBitStringFields();
    fields.put(UsRiField.GPC_SEGMENT_TYPE.toString(), new EncodableFixedInteger(2, 1));
    fields.put(UsRiField.GPC_SEGMENT_INCLUDED.toString(), new EncodableBoolean(true));
    fields.put(UsRiField.GPC.toString(), new EncodableBoolean(false));
    return fields;
  }
  ...
  protected decodeSegment(encodedString: string, fields: EncodableBitStringFields): void {
    ...
    try {
      ...
      throw new DecodingError("Unable to decode UsRiGpcSegment '" + encodedString + "'");
    }
  }
}
