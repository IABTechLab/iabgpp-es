...
import { UsKy_SENSITIVE_DATA_CONSENT_SEGMENT_FIELD_NAMES } from "../field/UsKyField.js";
import { UsKyField } from "../field/UsKyField.js";
import { AbstractLazilyEncodableSegment } from "./AbstractLazilyEncodableSegment.js";

export class UsKySensitiveDataConsentSegment extends AbstractLazilyEncodableSegment<EncodableBitStringFields> {
  ...
  public getFieldNames(): string[] {
    return UsKy_SENSITIVE_DATA_CONSENT_SEGMENT_FIELD_NAMES;
  }
  ...
  protected initializeFields(): EncodableBitStringFields {
    ...
    fields.put(UsKyField.SENSITIVE_DATA_CONSENT_SEGMENT_INCLUDED.toString(), new EncodableBoolean(true));
    fields.put(
      UsKyField.SENSITIVE_DATA_PROCESSING.toString(),
  ...
  protected decodeSegment(encodedString: string, fields: EncodableBitStringFields): void {
    ...
    try {
      ...
      throw new DecodingError("Unable to decode UsKySensitiveDataConsentSegment '" + encodedString + "'");
    }
  }
}
